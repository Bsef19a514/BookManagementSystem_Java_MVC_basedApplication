...
<head>
    ...
    <script language="JavaScript" type="text/javaScript">
        ...
        function validateSearch() { if(document.searchBook.sbook.value==""||document.searchBook.sbook.value==null) { document.getElementById("error_sbook").innerHTML="*Please enter Book name to search"; return false; } else { document.getElementById("error_sbook").innerHTML="";
        return true; } }
    </script>
</head>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="menus">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="addNewAccount.jsp">Add Account</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link active" href="addNewBook.jsp">Add Book</a>
                        </li>
